...
describe("HistoryPanel", () => {
  ...
  it("renders each run with its RU status label and timestamps", async () => {
    const runs: RunSummary[] = [
      { run_id: "r1", status: "completed", started_at: "2026-01-01T10:00:00Z", finished_at: "2026-01-01T10:00:05Z", duration_ms: 5000 },
      { run_id: "r2", status: "failed", started_at: "2026-01-02T10:00:00Z", finished_at: null, duration_ms: null },
    ];
  ...
  it("selecting a run shows its trace in the detail pane", async () => {
    vi.spyOn(flowClient, "fetchRunHistory").mockResolvedValue([
      { run_id: "r1", status: "completed", started_at: "2026-01-01T10:00:00Z", finished_at: null, duration_ms: null },
    ]);
